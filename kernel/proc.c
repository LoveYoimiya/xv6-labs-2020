...
procinit(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
      ...
      // moved from procinit() to allocproc()
...
// free the process's kernel pagetabel recursively
...
userinit(void)
{
  ...
  p->sz = PGSIZE;
  // map first user process's user pagetable to its kernel pagetable
...
fork(void)
{
  ...
  // copy to child process's kernnel pagetable
